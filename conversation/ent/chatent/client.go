...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	if _, ok := c.driver.(*txDriver); ok {
		return nil, errors.New("chatent: cannot start a transaction within a transaction")
	}
	tx, err := newTx(ctx, c.driver)
	if err != nil {
		return nil, fmt.Errorf("chatent: starting a transaction: %w", err)
	}
	cfg := c.config
	cfg.driver = tx
	return &Tx{
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("chatent: unknown mutation type %T", m)
	}
}
...
func (c *MessageClient) mutate(ctx context.Context, m *MessageMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("chatent: unknown Message mutation op: %q", m.Op())
	}
}
...
func (c *SessionClient) mutate(ctx context.Context, m *SessionMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("chatent: unknown Session mutation op: %q", m.Op())
	}
}
